WITH precos_por_produto AS (
    SELECT
        ...
        p.categoria,
        p.marca,
        p.preco_atual::DECIMAL(10,2) AS nosso_preco,
        AVG(pc.preco_concorrente)::NUMERIC(12,2) AS preco_medio_concorrentes,
        MIN(pc.preco_concorrente)::NUMERIC(12,2) AS preco_minimo_concorrentes,
        MAX(pc.preco_concorrente)::NUMERIC(12,2) AS preco_maximo_concorrentes,
...
SELECT
    ...
    (((pp.nosso_preco - pp.preco_medio_concorrentes) / NULLIF(pp.preco_medio_concorrentes, 0)) * 100)::NUMERIC(12,2) AS diferenca_percentual_vs_media,
    (((pp.nosso_preco - pp.preco_minimo_concorrentes) / NULLIF(pp.preco_minimo_concorrentes, 0)) * 100)::NUMERIC(12,2) AS diferenca_percentual_vs_minimo,
    CASE
    ...
    COALESCE(vp.receita_total, 0)::NUMERIC(12,2) AS receita_total,
